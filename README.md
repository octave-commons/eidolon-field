...
pnpm add @promethean-os/eidolon-field
...
- [@promethean-os/persistence](../persistence/README.md) — `orgs/riatzukiza/promethean/packages/persistence`
- [@promethean-os/test-utils](../test-utils/README.md) — `orgs/riatzukiza/promethean/packages/test-utils`

## Internal Dependents

- [@promethean-os/ai-learning](../ai-learning/README.md) — `orgs/riatzukiza/promethean/packages/ai-learning`
